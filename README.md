...
'''Returns a list of dictionaries, identifyinging sematic roles for various verbs in sentence.'''
...
'''Returns syntax tree in penn Tree Bank Format.'''
...
'''Returns dependency Relations as a string. Each relation is in new line. You may require some post processing on this.'''
